...
import shivansh.soni.code.sunshine.MainActivity;
import shivansh.soni.code.sunshine.R;
import shivansh.soni.code.sunshine.Utility;
import shivansh.soni.code.sunshine.data.WeatherContract;
import shivansh.soni.code.sunshine.data.WeatherContract.WeatherEntry;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static void syncImmediately(Context context) {
        ...
        ContentResolver.requestSync(account,
                "shivansh.soni.code.sunshine", bundle);
    }
    ...
    private String getWeatherForecastData(String postalCode) {
        ...
        try {
            Uri.Builder built_uri = Uri.parse(BASE_PARAM).buildUpon()
                    ...
                    .appendQueryParameter(APPID_PARAM, "cb40653bb3f3e443cb175fa507098fd7");
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
        ...
        ContentResolver.setSyncAutomatically(newAccount, "shivansh.soni.code.sunshine", true);
    ...
    public static void configurePeriodicSync(Context context, int syncInterval, int flexTime) {
        ...
        Account account = getSyncAccount(context);
        String authority = "shivansh.soni.code.sunshine.app";
    ...
    private void getWeatherDataFromJson(String forecastJsonStr, String locationSetting)
        ...
        if(cVVector.size()>0){
            ...
            String yesterday_date=calendar.getTime().toString();
            getContext().getContentResolver().delete(WeatherEntry.CONTENT_URI,WeatherEntry.COLUMN_DATE_TEXT+" <= ? ",
                    new String[] {yesterday_date});
        }
        ...
        if (CVVector.size() > 0) {
            ...
            if (DEBUG) {
                ...
                if (weatherCursor.moveToFirst()) {
                    ...
                    Log.v("Shivansh", "Query succeeded! **********");
                    for (String key : resultValues.keySet()) {
                        Log.v("Shivansh", key + ": " + resultValues.getAsString(key));
                    }
                } else {
                    Log.v("Shivansh", "Query failed! :( **********");
                }
            }
        }
    }
