...
public class Utility {
    ...
    public static String getPreferredLocation(Context mContext){
        ...
        return sharedPreferences.getString(mContext.getString(R.string.ZIP_pref),"201012");
    }
    ...
    public static boolean isMetric(Context mContext) {
        ...
        if(shared.getString(mContext.getString(R.string.UNIT_pref),"0").matches("0")){
            return true;
        }
        else{
            return false;
    ...
    public static String getformattedTemp(double temp, boolean isMetric) {
        if(isMetric)
